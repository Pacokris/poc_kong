...
describe('AppComponent', () => {
  ...
  it(`should have as title 'Welcome to FormAnguKong'`, () => {
    expect(appComponent.title).toEqual('Welcome to FormAnguKong');
  });

  it('should render title in a h1 tag', () => {
    expect(fixture.debugElement.nativeElement.querySelector('h1').textContent).toContain('Welcome to FormAnguKong');
  });
